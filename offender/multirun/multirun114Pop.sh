...
########### first batch ###############
for i in config/pretest114Pop/test10.ini config/pretest114Pop/test11.ini config/pretest114Pop/test12.ini config/pretest114Pop/test13.ini config/pretest114Pop/test14.ini config/pretest114Pop/test15.ini config/pretest114Pop/test16.ini config/pretest114Pop/test17.ini config/pretest114Pop/test18.ini ; do 
    offender/run.py `echo "$i"|sed -e 's:config/::'` &
    sleep 1
done
